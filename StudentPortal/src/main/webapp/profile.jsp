...
<body>
		...
		<div class="container my-4">
	        <div class="jumbotron">
	            <h2><u>Welcome to Student Portal</u></h2>
	            <%
					...
					if(session.getAttribute("username") == null){
		            	...
		            	String lastname = x[1].substring(0, x[1].length()-4);
		            	out.print("<strong>Fist Name	: </strong>" + firstname + "<br>");
		            	out.print("<strong>Last Name	: </strong>" + lastname + "<br>");
		            	out.print("<strong>User Name	: </strong>" + user + "<br>");
					}
	            %>
	          </div>
     	 </div>
